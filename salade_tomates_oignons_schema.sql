...
9. Servez chaud sur du riz.', 60, 'curry_poulet.jpg', 'some_account_id');
...
11. Garnissez de quartiers de citron et d''aneth frais.', 30, 'saumon_grille.jpg', 'some_account_id');
...
6. Vérifiez la cuisson et laissez reposer 10 minutes avant de servir.', 100, 'poulet_roti_herbes.jpg', 'some_account_id');
...
6. Servez immédiatement avec du parmesan supplémentaire.', 20, 'pates_carbonara.jpg', 'some_account_id');
...
6. Servez immédiatement.', 25, 'salade_cesar.jpg', 'some_account_id');
...
7. Servez chaud ou froid.', 70, 'ratatouille.jpg', 'some_account_id');
...
7. Enfournez pour 30-35 minutes.', 50, 'tarte_aux_pommes.jpg', 'some_account_id');
...
6. Parsemez de basilic frais ciselé avant de servir.', 15, 'salade_tomates_oignons.jpg', 'some_account_id');
...
7. Servez garni de cacahuètes concassées et de coriandre fraîche.', 30, 'pad_thai.jpg', 'some_account_id');
...
7. Garnissez de quartiers de citron et servez chaud.', 60, 'paella_valenciana.jpg', 'some_account_id');
...
8. Servez avec de la sauce soja, du wasabi et du gingembre mariné.', 45, 'sushi_maki.jpg', 'some_account_id');
...
8. Servez chaud avec des pommes de terre vapeur ou des pâtes.', 180, 'boeuf_bourguignon.jpg', 'some_account_id');
...
8. Servez chaud dans du pain pita avec de la salade et de la sauce tahini.', 40, 'falafel.jpg', 'some_account_id');
...
8. Servez immédiatement et dégustez pendant que c''est chaud.', 60, 'poutine.jpg', 'some_account_id');
...
10. Servez chaud avec du riz jaune.', 75, 'bobotie.jpg', 'some_account_id');
...
8. Servez garni de cacahuètes concassées et de coriandre fraîche.', 30, 'pad_thai.jpg', 'some_account_id');
...
8. Servez avec du harissa à part.', 120, 'couscous_royal.jpg', 'some_account_id');
...
9. Servez avec de la sauce soja, du wasabi et du gingembre mariné.', 60, 'sushi_rolls.jpg', 'some_account_id');
...
8. Retirez du feu, couvrez et laissez reposer 5-10 minutes avant de servir.', 60, 'paella_valenciana.jpg', 'some_account_id');
...
7. Servez chaud avec une cuillère de crème fraîche et du pain noir.', 90, 'borscht.jpg', 'some_account_id');
...
8. Laissez reposer 15 minutes avant de servir.', 120, 'moussaka.jpg', 'some_account_id');
...
8. Servez la feijoada avec le riz, le manioc frit, les quartiers d''orange et la farofa.', 180, 'feijoada.jpg', 'some_account_id');
...
8. Servez avec du citron vert et de la sauce sriracha.', 240, 'pho.jpg', 'some_account_id');
...
8. Accompagnez de riz ou de tortillas.', 120, 'chili_con_carne.jpg', 'some_account_id');
...
10. Servez frais avec des tranches de pain grillé.', 30, 'salade_nicoise.jpg', 'some_account_id');
